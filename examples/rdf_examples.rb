...
require 'rdf_examples/simple_class_config_example'
require 'rdf_examples/other_class_config_example'
require 'rdf_examples/multi_value_example'
require 'rdf_examples/person'
require 'rdf_examples/thing'
